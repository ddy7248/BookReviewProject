							...
							<c:if test="${ list != null }">
								<c:forEach var="dto" items="${ list }">
									<tr>
										...
										<td>${ dto.id }</td>
										<td>
											<a href="view.do?no=${ dto.no }">${ dto.bookTitle }</a>
						...
						<div class="search-bar input-group">
							<select name="searchType" class="form-control">
								...
								<option value="bookTitle"
									<c:if test="${ searchType eq 'bookTitle' }">selected</c:if> 
								>책제목</option>
								<option value="author"
									<c:if test="${ searchType eq 'author' }">selected</c:if>
								>저자</option>
								<option value="publisher"
									<c:if test="${ searchType eq 'publisher' }">selected</c:if>
								>출판사</option>
								<option value="id"
