						...
						<c:forEach var="dto" items="${ comList }">
							<form action="modifyCom.do" method="post">
								<tr id="arr${ dto.no }">
									...
									<td>
										<textarea class="form-control" name="comment" cols="80" rows="5">${ dto.contents }</textarea>
									</td>
