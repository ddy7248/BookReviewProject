...
public class RecoBookCommand implements Command {
...
try{    
			...
			String urlstr = "http://book.interpark.com/api/recommend.api?key="+key+"&categoryId=100&output=json";
			...
			request.setAttribute("reco", list);
			request.setAttribute("pageNum", pageNum);
			request.setAttribute("pageType", "reco");
			HttpSession session = request.getSession();
			
			if(session.getAttribute("curPage") != null)	request.setAttribute("curPage", (int)session.getAttribute("curPage"));
